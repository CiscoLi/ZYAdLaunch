...
-(void)example
{
     ...
     *  1.显示启动页广告
     */
    [ZYLaunchAd showWithAdFrame:CGRectMake(0, 0,self.window.bounds.size.width, self.window.bounds.size.height * 0.9) setAdImage:^(ZYLaunchAd *launchAd) {
        ...
        [self requestImageData:^(NSString *imgUrl, NSInteger duration, NSString *openUrl) {
            ...
            [launchAd setImageUrl:imgUrl duration:duration skipType:SkipTypeTimeText options:ZYWebImageDefault completed:^(UIImage *image, NSURL *url) {
